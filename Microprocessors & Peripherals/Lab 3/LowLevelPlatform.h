...
class TLowLevelPlatform : public redBlocks::Core::NoInstanceBase
{
  public:
    ...
    typedef redBlocks::HAL::Drivers::TDigitalInputDriverStub<8> Product4Button;
		typedef redBlocks::HAL::Drivers::TDigitalInputDriverStub<9> DicustomButton;
    ...
    static void initLowLevelDrivers()
    {
      ...
      SimulationStubs::DigitalInput::add<PowerSupervision>( SimulationStubs::DigitalInput::TRIGGER_EDGE_BOTH );
      ...
      SimulationStubs::DigitalInput::add<Product4Button>( SimulationStubs::DigitalInput::TRIGGER_EDGE_RISING );
			SimulationStubs::DigitalInput::add<DicustomButton>(SimulationStubs::DigitalInput::TRIGGER_EDGE_BOTH);
