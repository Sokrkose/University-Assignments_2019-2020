...
RB_CONNECT_ISR_CBK( Platform::PowerSupervision, Platform::PowerSupervision::CBK_ON_INPUT_CHANGED, /* HERE */)
...
RB_CONNECT_ISR_CBK(Platform::DicustomButton, Platform::DicustomButton::CBK_ON_INPUT_CHANGED, /** Empty */);
